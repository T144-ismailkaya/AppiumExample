...
public class Driver {
    ...
    static final String TELEFONADI = ConfigReader.getProperty("TELEFONADI");
    static final String ANDROIDVERSION = ConfigReader.getProperty("ANDROIDVERSION");
    static final String PLATFORM = ConfigReader.getProperty("PLATFORM");
    static final String OTOMASYON_ISMI = ConfigReader.getProperty("OTOMASYON_ISMI");
